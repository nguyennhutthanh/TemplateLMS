...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTimes, faRocket, faUserCircle, faFolder } from "@fortawesome/free-solid-svg-icons";
				...
				<SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
					<div className="sidebar-inner px-4 pt-3">
						...
						<Nav className="flex-column pt-3 pt-md-0">
							...
							<NavItem title="User" icon={faUserCircle} link={Routes.User.path} />
							<NavItem title="Course" icon={faFolder} link={Routes.Course.path} />
							{/* 							
							<CollapsableNavItem eventKey="tables/" title="Tables" icon={faTable}>
								<NavItem title="Bootstrap Table" link={Routes.BootstrapTables.path} />
							</CollapsableNavItem> */}

							<NavItem title="Category" icon={faCog} link={Routes.Category.path} />
